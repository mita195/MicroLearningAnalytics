    ...
    window.special = {
        ...
        ToggleImages: function (initiator) {
            ...
            window.special.ElementsWithBackgroundImage.each(function () {
                ...
                var customImg = [
                    "",
                    "",
                    ""
                ];
        ...
        Off: function () {
            if ($('#specialButton').length || $('#specialButton2').length) {
                ...
                $('#specialButton').show();
                $('#specialButton2') && $('#specialButton2').show();
            } else {
                if ($msie > 0) {
        ...
        On: function () {
            ...
            if ($('#specialButton').length || $('#specialButton2').length) {
                ...
                $('#specialButton').hide();
                $('#specialButton2') && $('#specialButton2').hide();
            }
            $('html').addClass('special');
            $('body').prepend($($tpl));
            window.special.Set('On');

            $('#wrap_slabovid_butns_off').on('click', function () {
                window.special.Off();
            });

            $('#wrap_slabovid_butns_off2').on('click', function () {
                window.special.Off();
            });
